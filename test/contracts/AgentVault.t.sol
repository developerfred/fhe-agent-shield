...
contract TestableAgentVault {
    ...
    event CredentialAccessed(
        address indexed agentId, address indexed accessor, bytes32 indexed handle, uint256 timestamp
    );
...
contract AgentVaultTest is Test {
    ...
    function test_storeCredential_returnsUniqueHandle() public {
        vm.prank(alice);
        bytes32 handle1 = vault.storeCredential(123_456_789);
        bytes32 handle2 = vault.storeCredential(987_654_321);
    ...
    function test_storeCredential_emitsEvent() public {
        vm.prank(alice);
        bytes32 handle = vault.storeCredential(123_456_789);
    ...
    function test_retrieveCredential_returnsToPermitted() public {
        vm.prank(alice);
        bytes32 handle = vault.storeCredential(12_345);
        ...
        assertEq(value, 12_345, "Should return correct value");
    }
